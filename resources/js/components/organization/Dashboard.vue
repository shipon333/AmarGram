                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">TK {{ data.balance }}</span>
                                </div>
                                <div class="info-box-content">
                                </div>
                            </div>
                            ...
                            <div class="info-box">
                                <a href="">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">TK {{ data.income }}</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="info-box">
                                <a href="">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">TK {{ data.expense }}</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="info-box">
                                <a href="">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">{{ data.resident_total }}</span>
                                    </div>
                                    <div class="info-box-content">
                                        <span title="Male" class="text-success"><i class="fa fa-male"></i> {{ data.resident_male }}</span>
                                        <span title="Female" class="text-success"><i class="fa fa-female"></i> {{ data.resident_female }}</span>
                                        <span title="Others" class="text-success"><i class="fa fa-sheqel"></i> {{ data.resident_others }}</span>
                                    </div>
                                </a>
                            </div>
                        </div>
...
<script>
    export default {
        ...
        methods:{
            adminDashboard(){
                axios.get('/api/admin/dashboard'+'?userId='+User.id())
