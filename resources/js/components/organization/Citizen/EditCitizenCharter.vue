                        ...
                        <form>
                            <div class="box-body">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" @click.prevent="updateCitizenCharter" class="btn btn-info pull-right">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            axios.get('/api/citizen-charter/'+id)
        ...
        methods: {
            ...
            updateCitizenCharter(){
                var id = this.$route.params.id;
                axios.patch('/api/citizen-charter/'+id,this.form)
                    .then(res => {
                        toastr.success('Citizen Charter Update Successfully', {timeOut: 500});
                        this.resetData();
                        this.$router.push({name:'viewCitizenCharter'})
                    })
