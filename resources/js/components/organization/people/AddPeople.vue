                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-user-plus"></i> Add New Resident</h3>
                        </div><!-- /.box-header -->
                        <form>
                            <div class="box-body">
                                    ...
                                    <div class="row around10">
                                        ...
                                        <div v-show="!form.father_name" class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select v-model="form.father_id"  class="form-control select2" >
                                        ...
                                        <div v-show="!form.mother_name" class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select v-model="form.mother_id" class="form-control select2" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <img v-if="form.avatar" :src="form.avatar" alt="" width="50px" height="50px">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tshadow mb25 bozero">
                                    <h4 class="pagetitleh2">Other Info</h4>
                                    ...
                                    <div class="row around10">
                                        ...
                                        <div v-show="form.marital_status != 'Unmarried' && !form.spouse_name" class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select v-model="form.spouse_id" class="form-control select2" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select v-model="form.dependent_on"  class="form-control select2" >
                                ...
                                <div class="tshadow mb25 bozero">
                                    <h4 class="pagetitleh2">Identity Info</h4>
                                ...
                                <div class="tshadow mb25 bozero">
                                    <h4 class="pagetitleh2">Miscellaneous Info</h4>
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" @click.prevent="addPeople" class="btn btn-info pull-right">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        methods: {
            ...
            addPeople(){
                ...
                axios.post('/api/people',this.form)
                    .then(res => {
                        toastr.success('People Add Successfully', {timeOut: 500});
                        this.resetData();
                        this.getPeople();
                    })
                    .catch(error => {
            ...
            resetData(){
                ...
                this.form.religion = '';
                this.form.dependent_on  = '';
                this.form.old_age_allowance = '';
                this.form.is_freedom_fighter = '';
                this.form.freedom_fighter_allowance = '';
                this.form.is_disabled = '';
                this.form.disability_allowance = '';
                this.form.ward_no = '';
                this.form.height = '';
                this.form.weight = '';
                this.form.gender = '';
