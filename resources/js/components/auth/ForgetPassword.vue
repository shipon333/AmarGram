                            ...
                            <div class="bgoffsetbg">
                                <div class="loginbg">
                                    ...
                                    <div class="form-bottom">
                                        <h3 class="font-white bolds text-center">Reset Password</h3>
                                        <form class="" method="post">
                                            <div class="form-group">
                                                <input type="text" name="email" placeholder="Type your email" class="form-username form-control" id="form-username">
                                            </div>
                                            <button type="submit" class="btn btn-success">Send Reset Link</button>
                                        </form>
                                        <div class="text-center">
                                            <router-link to="/" class="forgot">
                                                <i class="fa fa-sign-in"></i> Go Back to Login
                                            </router-link>
                                        </div>
                                    </div>
                                </div>
